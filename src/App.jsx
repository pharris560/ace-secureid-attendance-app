        ...
        {(authMode === "login" || authMode === "signup") && (
          <>
            <div className="flex items-center my-6">
              ...
              <span className="px-4 text-xs text-slate-400 uppercase font-bold">Or continue with</span>
              <div className="flex-1 border-t border-slate-300 dark:border-slate-600"></div>
            </div>
            <div className="space-y-3">
              <button onClick={handleGoogleSignIn} type="button" className="w-full py-4 bg-white dark:bg-slate-700 text-slate-800 dark:text-white font-bold rounded-2xl shadow-lg flex items-center justify-center gap-3 hover:scale-105 active:scale-95 transition-all border border-slate-200 dark:border-slate-600">
            ...
            <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-md p-6 text-left text-left text-left text-left text-left">
              <div className={`${isDark ? 'bg-[#1a202c]' : 'bg-[#e0e5ec]'} w-full max-w-2xl rounded-[3.5rem] ${flatStyle} p-10 border border-white/10 animate-in zoom-in-95 text-left text-left text-left text-left text-left`}>
                <div className="flex justify-between items-center mb-10 text-slate-800 dark:text-white text-left text-left text-left text-left text-left">
                  <h2 className="text-2xl font-black uppercase tracking-tight leading-none text-left text-left text-left text-left text-left">Class Details</h2>
                ...
                <form onSubmit={handleSaveClass} className="space-y-6 text-left text-left text-left text-left text-left text-left">
                  ...
                  <div className="flex justify-center pt-4 text-left text-left text-left text-left text-left">
                    <button type="submit" className="px-14 py-4 bg-blue-600 text-white font-black rounded-2xl shadow-xl uppercase text-[11px] tracking-widest hover:scale-105 active:scale-95 transition-all text-left text-left text-left text-left text-left">Save Details</button>
                  </div>
                </form>
              </div>
            </div>
